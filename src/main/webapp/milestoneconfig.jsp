                ...
                <table id="milestoneConfigTable" class="table table-hover zebra-striped" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 80px;">Required Attendees</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <s:iterator value="attendees">
                                      ...
                                      <input type='text' style="width: 80px;height: 20px" cellspacing='0' id='name<%=counter%>' placeholder='<s:property value="attendee"/>'> </input> 
                                      <button id="delete" class="btn" onclick="deleteInput(document.getElementById('name<%=counter%>'));$(this).hide();  "><i class="icon-black icon-minus-sign"></i></button>
                ...
                <script type="text/javascript">
                   ...
                   var count = <%=counter%>
                    ...
                    function createInput(id){
                        ...
                        var text = "#" + id.id;
                        var newInput = "<input style='width: 80px; height: 20px' type='text' id='" + name + "' placeholder='' />"
                                    + "<button class='btn' onclick='deleteInput(document.getElementById('name<%=counter%>'));$(this).hide();'><i class='icon-black icon-minus-sign'></i> </button>";
                        //alert(name);
