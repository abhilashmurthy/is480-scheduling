 ...
 * @author User
 */
public class UpdateScheduleAction_old extends ActionSupport implements ServletRequestAware {

    private HttpServletRequest request;
    private static Logger logger = LoggerFactory.getLogger(UpdateScheduleAction_old.class);
